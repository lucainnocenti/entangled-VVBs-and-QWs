...
We investigate here the residual entanglement when projecting the coin DOF.
...
In~\cref{fig:ent_acc}b we try to change the unitary after the first optimal coin projection on two Hadamard QWs \highlight{(clarify)}.
